  ...
  new PureCounter();
    ...
    function validateForm() {
        if (!validateName() || !validateEmail() || !validateSubject() || !validateMessage()) {
            submitError.innerHTML = "Please fix these errors to submit";
            return false;
        }
        return true;
    }
    ...
    $("#submit-form").submit((e) => {
        ...
        if (validateForm()) {
            $.ajax({
                url: "https://script.google.com/macros/s/AKfycbxkIBOcQc7DeApgQ4tSh6FuhXqUP3R6P-kPS6qdiZ3hdSENXCC4SZFYlIKsjsp7LVLy/exec",
